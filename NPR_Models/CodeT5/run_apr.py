...
def main():
    ...
    if args.do_train:
        ...
        train_examples, train_data = data_preprocess.load_and_cache_gen_data(args, args.train_dir, pool, tokenizer, 'train',mode="train")
        if args.local_rank == -1:
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            # if args.do_eval and (int(cur_epoch) % 2 == 0 or int(cur_epoch) > int(args.num_train_epochs) -5 ): # every 2 epoch do eval, last 5 epoch all do eval
                ...
                if 'dev_loss' in dev_dataset:
                    ...
                    eval_examples, eval_data = data_preprocess.load_and_cache_gen_data(args, args.dev_dir, pool, tokenizer, 'dev',mode='dev')
    ...
    if args.do_test:
        ...
        for criteria in ['best-bleu']:
            ...
            eval_examples, eval_data = data_preprocess.load_and_cache_gen_data(args, args.test_filename, pool, tokenizer, 'test',
