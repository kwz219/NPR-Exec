...
lr=5e-5
batch_size=1 # don't change this value, because this is a set
beam_size=300
...
output_dir=/root/autodl-tmp/npr4j_addex/codet5_result
...
load_model_path=/root/autodl-tmp/npr4j_addex/codet5_trained/checkpoint-best-ppl/pytorch_model.bin # load checkpoint for eval
res_dir=$output_dir
summary_dir=$output_dir/summary_data
test_file=/root/autodl-tmp/npr4j_addex/autodl_npr4j_onehunk_bug_loc_statistics.json
model_name_or_path=/root/autodl-tmp/npr4j_addex/codet5-base
tokenizer_name=/root/autodl-tmp/npr4j_addex/codet5-base
